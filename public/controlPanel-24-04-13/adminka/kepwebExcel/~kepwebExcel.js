        ...
        changeWidth : function()
        {
		    ...
		    $(this.thead).mousemove(function(e)
		    {
		        if(pressed)
		        {
		            ...
		            $('td:eq(' + index + ')', this.tbody).css('min-width', start_width + (e.pageX - start_x) + 'px');
		            $('td:eq(' + index + ')', this.tbody).css('max-width', start_width + (e.pageX - start_x) + 'px');
		            item.css('min-width', start_width + (e.pageX - start_x) + 'px');
		            item.css('max-width', start_width + (e.pageX - start_x) + 'px');
		        }
		    });
